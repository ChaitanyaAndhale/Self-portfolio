...
/* ── Custom stat items ──────────────────────────────────────── */
const stats = [
    { icon: GitCommit, label: 'Total Commits', value: '200+', color: 'text-white' },
    { icon: Star, label: 'Stars Earned', value: '10+', color: 'text-primary' },
    { icon: GitPullRequest, label: 'Pull Requests', value: '15+', color: 'text-accent' },
    { icon: AlertCircle, label: 'Issues Raised', value: '20+', color: 'text-white/80' },
    { icon: Code2, label: 'Repos', value: '20+', color: 'text-primary' },
    { icon: Users, label: 'Contributions', value: '84+', color: 'text-white/90' },
];
                        ...
                        <div className="flex h-4 rounded-full overflow-hidden mb-4">
                            {languages.map((l) => (
                                <motion.div
                                    key={l.name}
                                    className="h-full"
                                    style={{ background: l.color, width: `${l.percent}%`, transformOrigin: 0 }}
                                    initial={{ scaleX: 0 }}
